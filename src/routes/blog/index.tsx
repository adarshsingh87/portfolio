      ...
      <main id="main" className="mx-auto max-w-3xl px-5 py-14">
        ...
        {entries.length === 0 ? (
          <div className="mt-10 rounded-2xl border border-dashed border-white/15 p-10 text-center">
            <p className="inline-block rounded-full border border-white/10 px-4 py-1.5 font-mono text-xs text-zinc-400">
              comming soon
            </p>
            ...
            <p className="mt-6 font-mono text-[11px] text-zinc-600">
              See BLOG_GUIDE.md for the 60-second workflow
            </p>
          </div>
        ) : (
              ...
              {entries.map((e) =>
                e.kind === 'internal' ? (
                  ...
                  >
                    ...
                    <h2
                      className="mt-2 text-xl font-bold tracking-tight group-hover:underline group-hover:decoration-[#d6fd51] group-hover:underline-offset-4"
                      style={{
                        viewTransitionName: blogTitleTransitionName(e.slug),
                      }}
                    >
                      {e.title}
                    </h2>
                  ...
                  >
                    ...
                    <h2 className="mt-2 text-xl font-bold tracking-tight group-hover:underline group-hover:decoration-[#d6fd51] group-hover:underline-offset-4">
                      {e.title}
                    </h2>
                    <p className="mt-2 text-sm text-zinc-400">
                      {e.description}
